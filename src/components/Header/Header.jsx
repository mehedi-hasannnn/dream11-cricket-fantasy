...
const Header = ({ coinCount, handleAddCoins }) => {
  return (
    <div>
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-end mt-4 gap-4">
          ...
          <a className="btn"> {coinCount} Coin <BsCoin size={20} /> </a>
        </div>
      </div>
      ...
      <div className="mt-10 w-full bg-black p-10 bg-[url('assets/bg-shadow.png')] bg-cover bg-center">
        <div className="flex flex-col justify-center text-center gap-4">
          ...
          <button onClick={handleAddCoins} className=" bg-[#E7FE29] w-40 mx-auto rounded-xl h-10 text-black font-bold">
            Claim Free Credit
          </button>
        </div>
      </div>
